...
import { Video, Users, Mic, MicOff, VideoOff, PhoneOff } from "lucide-react";
      ...
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <div className="bg-gray-900/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-4">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={hangUp}
              className="p-4 bg-red-500 hover:bg-red-600 rounded-xl transition-all transform hover:scale-110"
            >
